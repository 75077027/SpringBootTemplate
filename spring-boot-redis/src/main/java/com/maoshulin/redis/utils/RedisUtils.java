package com.maoshulin.redis.utils;
...
/**
 * 描述: 操作redis 工具类，依赖com.alibaba.fastjson 包
 * author: maoshulin
...
public class RedisUtils {
    ...
    public static void saveString(String key, String val) {
        ...
        ValueOperations<String, String> vo = redisUtils.redisTemplate.opsForValue();
        vo.set(key, val);
    }
    ...
    public static void saveToSet(String key, String val) {
        ...
        SetOperations<String, String> so = redisUtils.redisTemplate.opsForSet();
    ...
    public static boolean saveNX(String key, String val) {
        ...
        /** 设置成功，返回 1 设置失败，返回 0 **/
        return redisUtils.redisTemplate.execute((RedisCallback<Boolean>) connection -> {
    ...
    public static void saveString(String key, String val, int seconds) {
        ...
        redisUtils.redisTemplate.opsForValue().set(key, val, seconds, TimeUnit.SECONDS);
    }
    ...
    public static void saveSeq(String key, long seqNo) {
        ...
        redisUtils.redisTemplate.opsForValue().increment(key, seqNo);
    }
    ...
    public static void saveFloat(String key, float data) {
        ...
        redisUtils.redisTemplate.delete(key);
        redisUtils.redisTemplate.opsForValue().increment(key, data);
    }
    ...
    public static void saveBean(String key, Object obj) {
        ...
        redisUtils.redisTemplate.opsForValue().set(key, JSON.toJSONString(obj));
    }
    ...
    public static void saveBean(String key, Object obj, int seconds) {
        ...
        redisUtils.redisTemplate.opsForValue().set(key, JSON.toJSONString(obj), seconds, TimeUnit.SECONDS);
    }
    ...
    public static void saveToQueue(String key, String val, long size) {
        ...
        ListOperations<String, String> lo = redisUtils.redisTemplate.opsForList();
    ...
    public static String getString(String key) {
        redisUtils.redisTemplate.opsForValue().get(key);
    ...
    public static List<String> getFromQueue(String key, long size) {
        ...
        boolean flag = redisUtils.redisTemplate.execute((RedisCallback<Boolean>) connection -> {
    ...
    public static Long getSeqNext(String key) {
        ...
        return redisUtils.redisTemplate.execute((RedisCallback<Long>) connection -> {
    ...
    public static void getSeqBack(String key) {
        ...
        redisUtils.redisTemplate.execute((RedisCallback<Long>) connection -> connection.decr(key.getBytes()));
    ...
    public static Double incrFloat(String key, double incrBy) {
        ...
        return redisUtils.redisTemplate.execute((RedisCallback<Double>) connection -> {
    ...
    public static void delKey(String key) {
        ...
        redisUtils.redisTemplate.execute((RedisCallback<Long>) connection -> connection.del(key.getBytes()));
    }
    ...
    public static Set<Object> listSet(String setName) {
        ...
        return redisUtils.redisTemplate.opsForHash().keys(setName);
    ...
    public static Set<RedisZSetCommands.Tuple> listSortedsetRev(String key, int start, int end) {
        ...
        return redisUtils.redisTemplate.execute((RedisCallback<Set<RedisZSetCommands.Tuple>>) connection -> {
    ...
    public static void saveToSortedset(String key, Double score, String member) {
        ...
        redisUtils.redisTemplate.execute(
    ...
    public static <T> T getBeanFromMap(String key, String field, Class<T> clazz) {
        ...
        byte[] input = redisUtils.redisTemplate.execute((RedisCallback<byte[]>) connection -> {
    ...
    public static <T> Long lpush(String key, T value) {
        ...
        return redisUtils.redisTemplate.opsForList().leftPush(key, JSON.toJSONString(value));
    }
    ...
    public static <T> Long lpushx(String key, T value) {
        ...
        return redisUtils.redisTemplate.opsForList().leftPushIfPresent(key, JSON.toJSONString(value));
    }
    ...
    public static void hsetnx(String hName, String key, String value) {
        ...
        redisUtils.redisTemplate.execute((RedisCallback<Boolean>) connection -> connection.hSetNX(key.getBytes(),
